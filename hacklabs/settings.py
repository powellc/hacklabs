"""
Django settings for our hacklabs project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'hacklabs/apps'))
    ...
    ROOT_URLCONF = 'hacklabs.urls'

    WSGI_APPLICATION = 'hacklabs.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "hacklabs/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "hacklabs/static"),
    )
